...
Identify by dns: reads the peer's reverse name, from the resolver the node is given; a transport-layer identifier whose claim is detected. A technology of
